...
func main() {
	...
	if err == nil {
		fmt.Println(t_struct.Return[0].Volume)
		fmt.Printf("%v\n", strings.Split(t_struct.Return[1].Volume, "/"))
...
type App struct {
	...
	Owerns   []string `json:"owerns"`
}

type Appss struct {
	Appss []App  `json:"appss"`
}
...
func httppost(data string) {
	...
	if err != nil {
		...
		//fmt.Println(decoded)
		fmt.Println(decoded.Appss[0].Owerns[0])
